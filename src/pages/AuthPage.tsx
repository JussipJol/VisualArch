    ...
    <div style={{ width: '100vw', height: '100vh', display: 'flex', backgroundColor: '#000000', color: '#fff', fontFamily: '"Space Mono", monospace' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.03) 0%, transparent 60%)',
          zIndex: 0
        }} />
        ...
        <div style={{ maxWidth: '400px', width: '100%' }}>
          ...
          <form onSubmit={(e) => e.preventDefault()} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <input 
              ...
              style={{
                width: '100%', padding: '16px', backgroundColor: 'rgba(255,255,255,0.02)',
            ...
            <button 
              ...
              style={{
                ...
                fontFamily: '"Montserrat", sans-serif', textTransform: 'uppercase', letterSpacing: '1px',
          ...
          <div style={{ display: 'flex', gap: '15px' }}>
            <button className="oauth-btn" style={oauthBtnStyle}>
              {/* GitHub SVG Minimal */}
