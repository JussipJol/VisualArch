...
=======
  const openShare = (e: React.MouseEvent, p: Project) => {
    e.stopPropagation();
    setShareProject({ id: p._id, name: p.name });
  };
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                        ...
                        <div style={{ display: 'flex', gap: 4 }}>
                          {/* Share button */}
                          {!localProjects.isLocalId(p._id) && (
                            <button
                              onClick={e => openShare(e, p)}
                              title="Share workspace"
                              style={{ background: 'transparent', border: 'none', color: 'rgba(255,255,255,0.3)', cursor: 'pointer', fontSize: '0.8rem', padding: '0 6px', transition: 'color 0.2s', fontFamily: 'inherit' }}
