...
export const AuthPage = ({ mode }: { mode: 'login' | 'register' }) => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', backgroundColor: '#000000', color: '#fff', fontFamily: '"Space Mono", monospace', position: 'relative' }}>
      ...
      {/* LEFT: Branding — чисто чёрный, без сетки */}
      <div style={{
        flex: 1,
        position: 'relative',
        display: 'flex',
        ...
        <div style={{ maxWidth: '400px', width: '100%', position: 'relative', zIndex: 2 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {!isLogin && (
              <input
                ...
                style={{ width: '100%', padding: '16px', backgroundColor: '#0a0a0a', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', fontFamily: '"Space Mono", monospace', fontSize: '0.9rem', outline: 'none', transition: 'all 0.3s', boxSizing: 'border-box' }}
          ...
          <div style={{ display: 'flex', gap: '15px' }}>
            {[
              ...
              <button key={i} style={{ flex: 1, padding: '14px 0', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#0a0a0a', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', cursor: 'pointer', transition: 'all 0.3s' }}
                onMouseEnter={e => { e.currentTarget.style.background = '#141414'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.3)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#0a0a0a'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.1)'; }}>
                {btn.icon}
              </button>
            ))}
          </div>
