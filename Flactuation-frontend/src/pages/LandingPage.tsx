    ...
    <div style={{ width: '100vw', height: '100vh', position: 'relative', overflowY: 'auto', overflowX: 'hidden', background: '#000000', scrollBehavior: 'smooth' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '60px', maxWidth: '1400px', margin: '0 auto', width: '100%', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 500px', display: 'flex', flexDirection: 'column', gap: '60px' }}>
            <IDEAnimation />
            <div style={{ 
              paddingLeft: '20px', 
              borderLeft: '1px solid rgba(0, 255, 204, 0.3)',
              animation: 'subtleReveal 1s ease-out 0.5s both',
              marginTop: '20px'
            }}>
              <p style={{ 
                ...
                // SYSTEM_NOTE: <br/>
                Dataset for syntatic data is generating from our product <span style={{ color: '#00ffcc' }}>DataForge AI</span>
              </p>
              <a href="https://dataforge_ai.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <button style={{ 
                  padding: '10px 24px', 
                  background: '#ffffff', color: '#000000', 
                  border: '1px solid #ffffff', borderRadius: '50px', fontSize: '0.8rem', 
                  cursor: 'pointer', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px',
                  boxShadow: '0 4px 15px rgba(255,255,255,0.1)',
                  transition: 'all 0.4s ease', fontFamily: '"Space Mono", monospace'
                }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(255,255,255,0.3)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(255,255,255,0.1)'; }}
                >
