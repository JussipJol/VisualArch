export const translations = {
  en: {
    ...
    concept: {
      ...
      desc: 'The platform implements the concept of a continuous creation process. The user works in a unified workspace through five key stages:',
      node1: 'Canvas',
      node2: 'Design',
      node3: 'DB Data',
      node4: 'localhost',
      node5: 'IDE(frontend/backend)',
      desc2: 'These modes switch seamlessly and are synchronized via a single global state, erasing the line between architecture, design, and engineering.',
    },
    wheel: {
      num: '// PHASE ',
      hint: 'TAP TO SPIN',
  ...
  ru: {
    ...
    concept: {
      ...
      title2: 'без разрыва',
      desc: 'Платформа реализует концепцию непрерывного процесса создания. Пользователь работает в едином workspace, проходя пять ключевых этапов:',
      node1: 'Canvas',
      node2: 'Design',
      node3: 'DB Data',
      node4: 'localhost',
      node5: 'IDE(frontend/backend)',
      desc2: 'Эти режимы бесшовно переключаются и синхронизированы через единое глобальное состояние, стирая грань между архитектурой, дизайном и инжинирингом.',
    },
    wheel: {
      num: '// ФАЗА ',
      hint: 'TAP TO SPIN',
