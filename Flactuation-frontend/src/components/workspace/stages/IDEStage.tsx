  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: '#000' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
          <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.12)', letterSpacing: 5, fontFamily: '"Space Mono", monospace' }}>// NO CODE GENERATED</div>
          <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.25)', fontFamily: '"Space Mono", monospace' }}><span style={{ color: 'rgba(255,20,147,0.4)' }}>!</span> go to preview stage to generate your project</div>
        </div>
      ) : (
