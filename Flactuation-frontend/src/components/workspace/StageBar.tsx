        ...
        return (
          <React.Fragment key={s.id}>
            <button
              ...
              onMouseEnter={e => { if (!isActive && !isGenerating) { (e.currentTarget as HTMLButtonElement).style.color = accent; (e.currentTarget as HTMLButtonElement).style.background = `${accent}08`; } }}
